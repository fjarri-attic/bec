...
\subsection*{Diffusion matrix decomposition}

Now there is a tricky bit. Let us write down the second order derivative part of equation~[\ref{full_wigner_equation}]
in a matrix form, dropping out
\[
