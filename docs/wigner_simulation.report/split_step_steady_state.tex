...
Time step in this process has an upper limit, which can be seen by substituting general solution
\ref{split_step_steady_state:general_solution_imaginary_time} into equation
\ref{split_step_steady_state:iterative_process}:
\[ \psi(t + dt) \simeq \sum_k e^{-\frac{1}{h} \mu_k t} f_k(\mathbf{r}) \left( 1 - dt \frac{\mu_k}{\hbar} \right) \]
which immediately gives us the necessary condition for the convergence of the iterative process:
\[ dt < \frac{\hbar}{\mu_1} \]
