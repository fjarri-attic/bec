...
\begin{eqnarray*}
\frac{\partial W}{\partial t} & =  & - \frac{\partial}{\partial \psi_1} i \left( - \hat{K}_1 + \Gamma_{11} \left( 1 - \vert \psi_1 \vert^2 \right) +
\Gamma_{12} \left( \frac{1}{2} - \vert \psi_2 \vert^2 \right) \right) \psi_1 W - \\
& - & \frac{\partial}{\partial \psi_2} i \left( - \hat{K}_2 + \Gamma_{22} \left( 1 - \vert \psi_2 \vert^2 \right) +
\Gamma_{12} \left( \frac{1}{2} - \vert \psi_1 \vert^2 \right) \right) \psi_2 W +
\textrm{c.c.}
\end{eqnarray*}
