...
Va=0.5;Vb=1;                                             //set to 1 with vacuum noise, 0 otherwise
...
for j=1:ne;										        //loop over ensembles
    da=0.5*grand(nv,4,'nor',0.0,sdz);		            //Initialises ns gaussian noises in x-space
    a=a0+Va*(da(:,1)+%i*da(:,2));					              //Initialises a-ensemble amplitudes with vacuum noise
    b=Vb*(da(:,3)+%i*da(:,4));					                 //Initialises b-ensemble amplitudes with vacuum noise
    b=fft(b,1);                                          //FFT into k-space
    a=fft(a,1);                                         //FFT into k-space
//////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////      										
    ...
    at=fft(a);                                          //transform back to x-space 
