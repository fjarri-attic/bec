...
\textcolor{red}{[Pictures needed?]}

\section{Two-component evolution}

Now when we have got the ground state for one-component system, it is the time to start the simulation of two-component system.
