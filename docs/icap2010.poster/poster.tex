...
\definecolor{textblock}{RGB}{0,120,120}
\definecolor{equation}{RGB}{0,0,250}
...
& \color{equation}\left. + \frac{\hbar}{2} \left(
		\tilde{\Omega} e^{i \omega t} + \tilde{\Omega}^* e^{-i \omega t}
	\right)
	\left(
...
\tiny{ \begin{thebibliography}{9}
	...
	\bibitem{norrie} Norrie, A., Ballagh, R. and Gardiner, C., \textit{Phys. Rev. A} \textbf{73} 043617 (2006)
\end{thebibliography} }
...
\tiny{ \begin{thebibliography}{9}
	\bibitem{burt} Burt, E., Ghrist, R. , Myatt, C. , Holland, M. , Cornell, E. and Wieman, C.,
		\textit{Phys. Rev. Lett.} \textbf{79} 337--440 (1997)
	\bibitem{jack} Jack, M., \textit{Phys. Rev. Lett.} \textbf{89} 140402 (2002)
	\bibitem{mertes} Mertes, K., Merrill, J. ,  Carretero-Gonz\'alez, R.,  Frantzeskakis, D.,  Kevrekidis, P. and Hall, D.,
...
\tiny{ \begin{thebibliography}{9}
	...
	\bibitem{norrie} Norrie, A., Ballagh, R. and Gardiner, C., \textit{Phys. Rev. A} \textbf{73} 043617 (2006)
	\bibitem{sinatra} Sinatra, A., Lobo, C. and Castin, Y., \textit{J. Phys. B: At. Mol. Opt. Phys.} \textbf{35} 3599--3631 (2002)
\end{thebibliography} }
...
\tiny{ \begin{thebibliography}{9}
	\bibitem{scott} Scott, R., Hutchinson, D. and Gardiner, C., \textit{Phys. Rev. A} \textbf{74} 053605 (2006)
\end{thebibliography} }
\end{block}
